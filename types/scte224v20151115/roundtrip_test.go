...
const CALI_XML = `<Media xmlns:audience="urn:scte:224:audience" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:action="urn:scte:224:action" xmlns="http://www.scte.org/schemas/224/2015" id="nbcuni.com/media/NBCS_CALIFORNIA/BROADCAST" description="NBCS_CALIFORNIA" lastUpdated="2018-05-29T00:44:57.000Z" source="CSN_WEST">
