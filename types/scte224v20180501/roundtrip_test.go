...
const CALI_XML = `<Media xmlns:audience="urn:scte:224:audience" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:action="urn:scte:224:action" xmlns="http://www.scte.org/schemas/224" id="superflaco.com/media/CALIFORNIA/BROADCAST" description="CALIFORNIA" lastUpdated="2018-05-29T00:44:57.000Z" source="CURRENT_CHANNEL">
<MediaPoint id="superflaco.com/media/AIRING_ID/program/PROGRAM_IDENTIFIER/start" description="I am a MediaPoint" lastUpdated="2018-05-08T00:49:37.000Z" effective="2018-05-29T00:00:00.000Z" expires="2018-05-29T10:00:00.000Z" source="CURRENT_CHANNEL">
...
<Assert>/SpliceInfoSection/SegmentationDescriptor[@segmentationTypeId=16]/SegmentationUpid[@segmentationUpidType=1 and text()='SIGNAL_UPID']</Assert>
<Assert>/SpliceInfoSection/SegmentationDescriptor[@segmentationTypeId=1]/SegmentationUpid[@segmentationUpidType=1 and text()='SIGNAL_UPID']</Assert>
</MatchSignal>
</MediaPoint></Media>`
